...
public class GetBitCoinBatchService implements CommandLineRunner {
	 ...
	 * @throws IOException
	 */
	private void getBalance(Timestamp ts) throws IOException {
		...
		jsonData = getHttpRequest(ENDPOINTURI, path, method, ts, query, apiKey, apiSecret);
	...
	public String getHttpRequest(String site_url, String path, String method, Timestamp ts, String query, String apiKey,
		...
		try {
			...
			String data = ts.toString() + method + path + query;
